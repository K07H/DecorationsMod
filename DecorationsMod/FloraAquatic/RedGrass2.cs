    ...
    class RedGrass2 : DecorationItem, ICustomFlora
    {
...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/flora/shared/coral_reef_red_seaweed_02_short");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Coral_reef/Coral_reef_red_seaweed_02_short");
#endif

            this.TechType = SMLHelper.V2.Handlers.TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("RedGrassName") + " (2)",
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("redgrass1icon"));
