    ...
    public class CrabClawKelp2 : DecorationItem, ICustomFlora
    {
        ...
        public CrabClawKelp2()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("CrabClawKelpName") + " (1)",
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("lostriverplant2icon"));
#endif
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Log("DEBUG: CrabClawKelp2 T1");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp2 T4");
#endif
            // Update rigid body
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp2 T5");
#endif
            // Add EntityTag
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp2 T6");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp2 T7");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp2 T8");
#endif
            // Add world forces
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp2 T9");
#endif
