...
namespace DecorationsMod.FloraAquatic
{
    public class RedGrass1 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public RedGrass1() : base("RedGrass1", LanguageHelper.GetFriendlyWord("RedGrassName") + " (1)", LanguageHelper.GetFriendlyWord("RedGrassDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("redgrasstinyicon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("redgrasstinyicon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: redGrass1.GetGameObject()");
#endif
            if (_redGrass1 == null)
#if SUBNAUTICA
