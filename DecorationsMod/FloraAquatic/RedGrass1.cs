    ...
    public class RedGrass1 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public RedGrass1() : base("RedGrass1", "RedGrassName", "RedGrassDescription", "redgrasstinyicon", "1")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("redgrasstinyicon"));
#endif
