...
namespace DecorationsMod.FloraAquatic
{
    public class BloodGrassDense : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public BloodGrassDense() : base("BloodGrassDense", LanguageHelper.GetFriendlyWord("RedGrassDenseName") + " (2)", LanguageHelper.GetFriendlyWord("RedGrassDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("bloodgrassdense2icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("bloodgrassdense2icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            // Update sky applier
            PrefabsHelper.UpdateOrAddSkyApplier(prefab3Tall, null, prefab3Tall.GetAllComponentsInChildren<MeshRenderer>()); // dynamic true?
