    ...
    public class BloodGrassDense : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public BloodGrassDense() : base("BloodGrassDense", "RedGrassDenseName", "RedGrassDescription", "bloodgrassdense2icon", "2")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("bloodgrassdense2icon"));
#endif
