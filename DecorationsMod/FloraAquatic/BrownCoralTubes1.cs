...
namespace DecorationsMod.FloraAquatic
{
    public class BrownCoralTubes1 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public BrownCoralTubes1() : base("BrownCoralTubes1", LanguageHelper.GetFriendlyWord("BrownCoralTubesName") + " (1)", LanguageHelper.GetFriendlyWord("BrownCoralTubesDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("flora_browncoraltubes0203icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_browncoraltubes0203icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: brownCoralTubes1.GetGameObject()");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T1");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T2");
            Logger.PrintTransform(prefab.transform);
            Logger.Debug("DEBUG: BrownCoralTube1 T2b");
#endif
            // Scale models
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T3");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T4");
#endif
            // Update rigid body
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T5");
#endif
            // Add EntityTag
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T6");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T7");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T8");
#endif
            // Add world forces
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: BrownCoralTube1 T9");
#endif
