...
namespace DecorationsMod.FloraAquatic
{
    public class BrownCoralTubes1 : DecorationItem, ICustomFlora
    {
        ...
        public BrownCoralTubes1()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Coral_reef/coral_reef_brown_coral_tubes_02_03";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_browncoraltubes0203icon")));
        ...
        public override GameObject GetPrefab()
        {
            ...
            prefab.FindChild("coral_reef_brown_coral_tubes_02_03_LOD1").transform.localScale *= 0.4f;
            prefab.FindChild("coral_reef_brown_coral_tubes_02_03_LOD2").transform.localScale *= 0.4f;
