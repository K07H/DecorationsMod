...
namespace DecorationsMod.FloraAquatic
{
    public class GreenReeds1 : DecorationItem, ICustomFlora
    {
        ...
        public GreenReeds1()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Coral_reef/Coral_reef_green_reeds_01";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("spottedreeds1icon")));
