...
namespace DecorationsMod.FloraAquatic
{
    public class GreenReeds1 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public GreenReeds1() : base("GreenReeds1", LanguageHelper.GetFriendlyWord("GreenReedsName") + " (1)", LanguageHelper.GetFriendlyWord("GreenReedsDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("spottedreeds1icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("spottedreeds1icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: greenReeds1.GetGameObject()");
#endif
