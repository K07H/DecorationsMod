...
namespace DecorationsMod.FloraAquatic
{
    public class FloatingStone1 : DecorationItem, ICustomFlora
    {
        ...
        public FloatingStone1()
        {
            ...
            this.ResourcePath = "WorldEntities/Environment/Coral_reef_floating_stones_small_01";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("floatingstone1icon")));
