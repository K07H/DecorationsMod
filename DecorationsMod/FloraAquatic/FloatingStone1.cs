...
{
    public class FloatingStone1 : DecorationItem, ICustomFlora
    {
        ...
        {
            this.ClassID = "FloatingStone1"; // 228e5af5-a579-4c99-9fb0-04b653f73cd3
            this.PrefabFileName = DecorationItem.DefaultResourcePath + this.ClassID;

            this.GameObject = new GameObject(this.ClassID);

            this.TechType = SMLHelper.V2.Handlers.TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("FloatingStoneName"),
                                                        LanguageHelper.GetFriendlyWord("FloatingStoneDescription"),
                                                        true);

            CrafterLogicFixer.FloatingStone1 = this.TechType;
            ...
            this.Config = ConfigSwitcher.config_FloatingStone1;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("floatingstone1icon"));
        ...
        private static GameObject _floatingStone1 = null;

        public override GameObject GetGameObject()
        {
            if (_floatingStone1 == null)
#if SUBNAUTICA
                _floatingStone1 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Environment/Coral_reef_floating_stones_small_01.prefab");
#else
                _floatingStone1 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/deepgrandreef/Coral_reef_floating_stones_small_01.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_floatingStone1);
            ...
            // Scale model
            prefab.FindChild("model").transform.localScale *= 0.2f;
            ...
            // Add plant serializer/deserializer
