...
namespace DecorationsMod.FloraAquatic
{
    public class PyroCoral3 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public PyroCoral3() : base("PyroCoral3", LanguageHelper.GetFriendlyWord("PyroCoralName") + " (3)", LanguageHelper.GetFriendlyWord("PyroCoralDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("pyrocoral3icon"))
        {
            ...
            CrafterLogicFixer.PyroCoral3 = this.TechType;
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("pyrocoral3icon"));
        ...
        private static GameObject _pyroCoral3 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: pyroCoral3.GetGameObject()");
#endif
            if (_pyroCoral3 == null)
#if SUBNAUTICA
                _pyroCoral3 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Lost_river/lost_river_pillar_03.prefab");
#else
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T1");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T2");
#endif
            // Remove light
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T5");
#endif
            // Update rigid body
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T6");
#endif
            // Add EntityTag
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T7");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T8");
#endif
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T9");
#endif
            // Add world forces
...
#if DEBUG_CORALS
            Logger.Debug("DEBUG: PyroCoral3 T10");
#endif
