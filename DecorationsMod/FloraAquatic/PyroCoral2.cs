    ...
    public class PyroCoral2 : DecorationItem, ICustomFlora
    {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("pyrocoral2icon"));
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T1");
#endif
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T2");
#endif
            // Remove light
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T5");
#endif
            // Update rigid body
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T6");
#endif
            // Add EntityTag
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T7");
#endif
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T8");
#endif
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T9");
#endif
            // Add world forces
...
#if DEBUG_CORALS
            Logger.Log("DEBUG: PyroCoral2 T10");
#endif
