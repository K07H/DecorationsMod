...
{
    public class BloodGrassRed : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public BloodGrassRed() : base("BloodGrassRed", LanguageHelper.GetFriendlyWord("RedGrassDenseName") + " (1)", LanguageHelper.GetFriendlyWord("RedGrassDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("bloodgrassicon"))
        {
            ...
            this.Config = ConfigSwitcher.config_BloodGrassRed;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("bloodgrassicon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: bloodGrassRed.GetGameObject()");
#endif
            ...
            // Scale & rotate model
            GameObject model = prefab.FindChild("Coral_reef_grass_01_red");
            ...
            plantable.linkedGrownPlant.seedUID = "BloodGrassRed";
