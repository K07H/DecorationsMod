    ...
    public class BloodGrassRed : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public BloodGrassRed() : base("BloodGrassRed", "RedGrassDenseName", "RedGrassDescription", "bloodgrassicon", "1")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("bloodgrassicon"));
#endif
