...
namespace DecorationsMod.FloraAquatic
{
    public class SmallDeco10 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public SmallDeco10() : base("SmallDeco10", LanguageHelper.GetFriendlyWord("SmallDeco10Name"), LanguageHelper.GetFriendlyWord("SmallDeco10Description"), AssetsHelper.Assets.LoadAsset<Sprite>("flora_smalldeco10icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_smalldeco10icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: smallDeco10.GetGameObject()");
#endif
