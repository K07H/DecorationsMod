...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/environmentprops/lostriver/lost_river_pillar_01");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Lost_river/lost_river_pillar_01");
#endif
