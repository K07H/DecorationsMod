    ...
    public class CrabClawKelp3 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public CrabClawKelp3() : base("CrabClawKelp3", "CrabClawKelpName", "CrabClawKelpDescription", "lostriverplant3icon")
        {
            this.SetGameObject(this.GetGameObject());

            this.GameObject = new GameObject(this.ClassID);
#else
        public CrabClawKelp3()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("CrabClawKelpName") + " (3)",
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("lostriverplant3icon"));
#endif
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Log("DEBUG: CrabClawKelp3 T1");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp3 T4");
#endif
            // Update rigid body
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp3 T5");
#endif
            // Add EntityTag
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp3 T6");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp3 T7");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp3 T8");
#endif
            // Add world forces
...
#if DEBUG_CRABCLAWKELP
            Logger.Log("DEBUG: CrabClawKelp3 T9");
#endif
