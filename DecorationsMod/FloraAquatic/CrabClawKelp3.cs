...
{
    public class CrabClawKelp3 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public CrabClawKelp3() : base("CrabClawKelp3", LanguageHelper.GetFriendlyWord("CrabClawKelpName") + " (3)", LanguageHelper.GetFriendlyWord("CrabClawKelpDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("lostriverplant3icon"))
        {
            this.ClassID = "CrabClawKelp3"; // b628d104-dcad-4fac-8a12-d0c4ef473d93
            ...
            CrafterLogicFixer.CrabClawKelp3 = this.TechType;
            ...
            this.Config = ConfigSwitcher.config_CrabClawKelp3;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("lostriverplant3icon"));
        ...
        private static GameObject _crabClawKelp3 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: crabClawKelp3.GetGameObject()");
#endif
            if (_crabClawKelp3 == null)
#if SUBNAUTICA
                _crabClawKelp3 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Lost_river/lost_river_plant_01_03.prefab");
#else
                _crabClawKelp3 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/lost_river_plant_01_03.prefab");
#endif

#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T1");
#endif
            GameObject prefab = GameObject.Instantiate(_crabClawKelp3);
...
#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T2");
            Logger.PrintTransform(prefab.transform);
            Logger.Debug("DEBUG: CrabClawKelp3 T2b");
#endif
            // Scale prefab
            prefab.FindChild("lost_river_plant_01_03").transform.localScale *= 0.2f;

#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T3");
#endif
            // Shrink colliders
...
#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T4");
#endif
            // Update rigid body
...
#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T5");
#endif
            // Add EntityTag
...
#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T6");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T7");
#endif
...
#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T8");
#endif
            // Add world forces
            ...
            plantable.linkedGrownPlant.seedUID = "CrabClawKelp3";
...
#if DEBUG_CRABCLAWKELP
            Logger.Debug("DEBUG: CrabClawKelp3 T9");
#endif
