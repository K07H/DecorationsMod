...
namespace DecorationsMod.FloraAquatic
{
    public class CrabClawKelp3 : DecorationItem, ICustomFlora
    {
        ...
        public CrabClawKelp3()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Lost_river/lost_river_plant_01_03";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("lostriverplant3icon")));
