...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public CrabClawKelp3() : base("CrabClawKelp3", "CrabClawKelpName", "CrabClawKelpDescription", "lostriverplant3icon", "3")
        {
