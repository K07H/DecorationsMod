...
{
    class RedGrass2Tall : DecorationItem, ICustomFlora
    {
...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/flora/shared/coral_reef_red_seaweed_02_tall");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Coral_reef/Coral_reef_red_seaweed_02_tall");
#endif
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("redgrass2tallicon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            // Get model
            GameObject model = prefab.FindChild("Coral_reef_red_seaweed_02_tall");
            ...
            collider.size = new Vector3(0.3f, 0.6f, 0.3f);
            ...
            plantable.linkedGrownPlant.seedUID = "RedGrass2Tall";
