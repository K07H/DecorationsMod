...
namespace DecorationsMod.FloraAquatic
{
    class RedGrass2Tall : DecorationItem, ICustomFlora
    {
        ...
        private static GameObject _redGrass2Tall = null;
...
#else
                _redGrass2Tall = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/shared/coral_reef_red_seaweed_02_tall.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_redGrass2Tall);
