    ...
    public class SmallDeco13 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public SmallDeco13() : base("SmallDeco13", "SmallDeco13Name", "AlienFloraSampleDescription", "flora_smalldeco13icon")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_smalldeco13icon"));
#endif
