...
namespace DecorationsMod.FloraAquatic
{
    public class SmallDeco13 : DecorationItem, ICustomFlora
    {
        ...
        public SmallDeco13()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Coral_reef/coral_reef_small_deco_13";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_smalldeco13icon")));
