...
namespace DecorationsMod.FloraAquatic
{
    public class SmallDeco14 : DecorationItem, ICustomFlora
    {
        ...
        public SmallDeco14()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Coral_reef/coral_reef_small_deco_14";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_smalldeco14icon")));
