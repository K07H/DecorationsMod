...
namespace DecorationsMod.FloraAquatic
{
    public class PlantMiddle11 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public PlantMiddle11() : base("PlantMiddle11", LanguageHelper.GetFriendlyWord("PlantMiddle11Name"), LanguageHelper.GetFriendlyWord("PlantMiddle11Description"), AssetsHelper.Assets.LoadAsset<Sprite>("flora_plantmiddle11icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_plantmiddle11icon"));
        ...
        private static GameObject _plantMiddle11 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: plantMiddle11.GetGameObject()");
#endif
            if (_plantMiddle11 == null)
#if SUBNAUTICA
                _plantMiddle11 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Coral_reef/coral_reef_plant_middle_11.prefab");
#else
                _plantMiddle11 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/shared/coral_reef_plant_middle_11.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_plantMiddle11);
