...
namespace DecorationsMod.FloraAquatic
{
    public class GreenReeds6 : DecorationItem, ICustomFlora
    {
        ...
        public GreenReeds6()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Coral_reef/Coral_reef_green_reeds_06";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("spottedreedsicon")));
