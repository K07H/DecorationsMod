...
{
    public class GreenReeds6 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public GreenReeds6() : base("GreenReeds6", LanguageHelper.GetFriendlyWord("GreenReedsName") + " (2)", LanguageHelper.GetFriendlyWord("GreenReedsDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("spottedreedsicon"))
        {
            this.ClassID = "GreenReeds6"; // 133ae1eb-99ec-4b1d-b32b-9c9daf144b8f
            ...
            this.Config = ConfigSwitcher.config_GreenReeds6;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("spottedreedsicon"));
        ...
        private static GameObject _greenReeds6 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: greenReeds6.GetGameObject()");
#endif
            if (_greenReeds6 == null)
#if SUBNAUTICA
                _greenReeds6 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Coral_reef/Coral_reef_green_reeds_01.prefab");
#else
                _greenReeds6 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/shared/Coral_reef_green_reeds_01.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_greenReeds6);
            ...
            plantable.linkedGrownPlant.seedUID = "GreenReeds6";
