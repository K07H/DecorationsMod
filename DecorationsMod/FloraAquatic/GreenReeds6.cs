    ...
    public class GreenReeds6 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public GreenReeds6() : base("GreenReeds6", "GreenReedsName", "GreenReedsDescription", "spottedreedsicon", "2")
        {
        ...
        public GreenReeds6()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("GreenReedsName") + " (2)",
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("spottedreedsicon"));
#endif
