    ...
    class RedGrass3 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public RedGrass3() : base("RedGrass3", "RedGrassName", "RedGrassDescription", "redgrass3icon", "3")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("redgrass3icon"));
#endif
