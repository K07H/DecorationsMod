...
namespace DecorationsMod.FloraAquatic
{
    public class BlueCoralTubes1 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public BlueCoralTubes1() : base("BlueCoralTubes1", LanguageHelper.GetFriendlyWord("BlueCoralTubes1Name"), LanguageHelper.GetFriendlyWord("AlienFloraSampleDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("flora_bluecoraltubesicon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_bluecoraltubesicon"));
        ...
        private static GameObject _blueCoralTubes1 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: blueCoralTubes1.GetGameObject()");
#endif
            if (_blueCoralTubes1 == null)
#if SUBNAUTICA
                _blueCoralTubes1 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Coral_reef/Coral_reef_blue_coral_tubes.prefab");
#else
                _blueCoralTubes1 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Flora/Shared/Coral_reef_blue_coral_tubes.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_blueCoralTubes1);
