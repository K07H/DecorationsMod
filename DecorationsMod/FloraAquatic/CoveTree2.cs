...
namespace DecorationsMod.FloraAquatic
{
    public class CoveTree2 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public CoveTree2() : base("CoveTree2", LanguageHelper.GetFriendlyWord("GiantCoveTreeName"), LanguageHelper.GetFriendlyWord("CoveTreeDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("covetree2icon"))
        {
            ...
            {
                new Ingredient(ConfigSwitcher.FloraRecipiesResource, Convert.ToInt32((float)ConfigSwitcher.FloraRecipiesResourceAmount * 2.0f))
            });
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("covetree2icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: coveTree2.GetGameObject()");
#endif
            if (_coveTree2 == null)
#if SUBNAUTICA
