    ...
    public class CrabClawKelp1 : DecorationItem, ICustomFlora
    {
...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/flora/old/lost_river_plant_01_01");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Lost_river/lost_river_plant_01_01");
#endif

            this.TechType = SMLHelper.V2.Handlers.TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("CrabClawKelpName") + " (B)",
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("lostriverplant1icon"));
