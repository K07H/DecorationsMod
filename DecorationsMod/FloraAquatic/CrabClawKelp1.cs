...
namespace DecorationsMod.FloraAquatic
{
    public class CrabClawKelp1 : DecorationItem, ICustomFlora
    {
        ...
        public CrabClawKelp1()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Lost_river/lost_river_plant_01_01";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("lostriverplant1icon")));
