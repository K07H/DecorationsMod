...
namespace DecorationsMod.FloraAquatic
{
    public class SmallDeco11 : DecorationItem, ICustomFlora
    {
        ...
        public SmallDeco11()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Coral_reef/coral_reef_small_deco_11";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("flora_smalldeco11icon")));
        ...
        public override GameObject GetPrefab()
        {
            ...
            {
                if (tr.name.CompareTo("coral_reef_small_deco_11") == 0)
                    tr.localScale *= 0.4f;
            }
