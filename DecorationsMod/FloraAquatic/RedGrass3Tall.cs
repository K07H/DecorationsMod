...
namespace DecorationsMod.FloraAquatic
{
    class RedGrass3Tall : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public RedGrass3Tall() : base("RedGrass3Tall", LanguageHelper.GetFriendlyWord("RedGrassTallName") + " (2)", LanguageHelper.GetFriendlyWord("RedGrassDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("redgrass3tallicon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("redgrass3tallicon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: redGrass3Tall.GetGameObject()");
#endif
