    ...
    class RedGrass3Tall : DecorationItem, ICustomFlora
    {
...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/flora/shared/coral_reef_red_seaweed_03_tall");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Coral_reef/Coral_reef_red_seaweed_03_tall");
#endif
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("redgrass3tallicon"));
