...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public SeamothFragment2() : base("SeamothFragment2", LanguageHelper.GetFriendlyWord("SeamothFragmentName") + " (2)", LanguageHelper.GetFriendlyWord("SeamothFragmentDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment2icon")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment2icon"));

                this.IsRegistered = true;
            }
        }

        private static GameObject _seamothFragment2 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: seamothFragment2.GetGameObject()");
#endif
            if (_seamothFragment2 == null)
#if SUBNAUTICA
                _seamothFragment2 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Fragments/seamoth_fragment_02.prefab");
#else
                _seamothFragment2 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Alterra/Fragments/seamoth_fragment_02.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_seamothFragment2);
