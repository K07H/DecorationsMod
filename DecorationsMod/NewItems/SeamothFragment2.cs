    ...
    public class SeamothFragment2 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public SeamothFragment2() : base("SeamothFragment2", "SeamothFragmentName", " (2)", "SeamothFragmentDescription", "seamothfragment2icon")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment2icon"));
#endif
