...
namespace DecorationsMod.NewItems
{
    public class CargoBox01a : DecorationItem
    {
        ...
        [SetsRequiredMembers]
        public CargoBox01a() : base("CargoBox01a", LanguageHelper.GetFriendlyWord("CargoBox1aName"), LanguageHelper.GetFriendlyWord("CargoBox1aDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("cargobox01aicon"))
        {
            this.ClassID = "CargoBox01a";
            this.PrefabFileName = DecorationItem.DefaultResourcePath + this.ClassID;

            //this.GameObject = AssetsHelper.Assets.LoadAsset<GameObject>("cargobox01a");
        ...
        private static GameObject _cargoBox1a = null;
        ...
        public override void RegisterItem()
        {
            ...
            {
                if (_cargoBox1a == null)
                    _cargoBox1a = AssetsHelper.Assets.LoadAsset<GameObject>("cargobox01a");

                this.CargoCrateContainer = PrefabsHelper.LoadGameObjectFromFilename("Submarine/Build/Locker.prefab");

                GameObject model = _cargoBox1a.FindChild("cargobox01a");
                
                // Set tech tag
                var techTag = _cargoBox1a.AddComponent<TechTag>();
                techTag.type = this.TechType;

                // Add prefab identifier
                _cargoBox1a.AddComponent<PrefabIdentifier>().ClassId = this.ClassID;

                // Add collider
                var collider = _cargoBox1a.AddComponent<BoxCollider>();
                ...
                var renderers = _cargoBox1a.GetComponentsInChildren<Renderer>();
                ...
                _cargoBox1a.AddComponent<LargeWorldEntity>().cellLevel = LargeWorldEntity.CellLevel.Near;

                // Add contructable
                var constructible = _cargoBox1a.AddComponent<Constructable>();
                ...
                var bounds = _cargoBox1a.AddComponent<ConstructableBounds>();

                // Add model controler
                var cargoBoxController = _cargoBox1a.AddComponent<CargoBoxController>();
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("cargobox01aicon"));
        ...
        {
            GameObject prefab = GameObject.Instantiate(_cargoBox1a);
