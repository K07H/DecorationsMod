    ...
    public class SeamothFragment1 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public SeamothFragment1() : base("SeamothFragment1", "SeamothFragmentName", "SeamothFragmentDescription", "seamothfragment1icon", "1")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment1icon"));
#endif
