    ...
    public class AlienArtefact4 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public AlienArtefact4() : base("AlienArtefact4", "AlienRelic4Name", "AlienRelic4Description", "relic_05_b")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("relic_05_b"));
#endif
