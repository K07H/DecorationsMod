...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public AlienArtefact4() : base("AlienArtefact4", LanguageHelper.GetFriendlyWord("AlienRelic4Name"), LanguageHelper.GetFriendlyWord("AlienRelic4Description"), AssetsHelper.Assets.LoadAsset<Sprite>("relic_05_b")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("relic_05_b"));

                this.IsRegistered = true;
            }
        }

        private static GameObject _alienArtefact4 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: alienArtefact4.GetGameObject()");
#endif
            if (_alienArtefact4 == null)
#if SUBNAUTICA
                _alienArtefact4 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Precursor/Prison/Relics/Alien_relic_04.prefab");
#else
                _alienArtefact4 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Precursor/Relics/Alien_relic_04.prefab");
#endif

            //GameObject prefab = GameObject.Instantiate(this.GameObject);
            GameObject prefab = GameObject.Instantiate(_alienArtefact4);
