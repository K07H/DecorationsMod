    ...
    public class GenericSkeleton3 : DecorationItem
    {
        public GenericSkeleton3()
        {
            ...
            this.TechType = TechTypePatcher.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("GenericSkeletonName") + " (C)",
        ...
        public override void RegisterItem()
        {
            ...
            {
                GameObject model = this.GameObject.FindChild("Lost_river_generic_skeleton_03");
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("genericskeleton3icon")));
