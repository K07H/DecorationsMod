    ...
    public class LabContainerOpen2 : DecorationItem
    {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, new Atlas.Sprite(ImageUtils.LoadTextureFromFile("./QMods/DecorationsMod/Assets/labcontaineropen2.png")));
