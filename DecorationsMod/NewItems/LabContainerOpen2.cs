...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public LabContainerOpen2() : base("LabContainerOpen2", LanguageHelper.GetFriendlyWord("MediumLabContainerOpenName"), LanguageHelper.GetFriendlyWord("LabContainerOpenDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("labcontaineropen2")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("labcontaineropen2"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: labContainerOpen2.GetGameObject()");
#endif
