...
namespace DecorationsMod.NewItems
{
    public class LabContainerOpen2 : DecorationItem
    {
        public LabContainerOpen2() // Feeds abstract class
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Debris/Wrecks/Decoration/biodome_lab_containers_open_02";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, new Atlas.Sprite(ImageUtils.LoadTextureFromFile("./QMods/DecorationsMod/Assets/labcontaineropen2.png"))));
