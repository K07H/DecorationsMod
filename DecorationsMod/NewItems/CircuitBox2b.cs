...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public CircuitBox2b() : base("CircuitBox2b", LanguageHelper.GetFriendlyWord("CircuitBox2Name"), LanguageHelper.GetFriendlyWord("CircuitBox2Description"), AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox2b")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox2b"));

                this.IsRegistered = true;
            }
        }

        private static GameObject _circuitBox2b = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: circuitBox2b.GetGameObject()");
#endif
            if (_circuitBox2b == null)
#if SUBNAUTICA
                _circuitBox2b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Debris/Wrecks/Decoration/circuit_box_01_02.prefab");
#else
                _circuitBox2b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Alterra/Base/circuit_box_01_02.prefab");
#endif

            //GameObject prefab = GameObject.Instantiate(this.GameObject);
            GameObject prefab = GameObject.Instantiate(_circuitBox2b);
