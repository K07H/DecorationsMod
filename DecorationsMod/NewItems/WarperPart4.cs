...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public WarperPart4() : base("WarperPart4", LanguageHelper.GetFriendlyWord("HangingWarperPartName") + " (3)", LanguageHelper.GetFriendlyWord("HangingWarperPartDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_4"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.UpdateOrAddSkyApplier(_warperPart4, null, renderers);
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_4"));
