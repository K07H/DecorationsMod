...
namespace DecorationsMod.NewItems
{
    public class Folder1 : DecorationItem
    {
        ...
        public override void RegisterItem()
        {
            ...
            {
                GameObject model = this.GameObject.FindChild("docking_clerical_folder1");
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("folder1icon")));
