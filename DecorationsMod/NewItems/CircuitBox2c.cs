...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public CircuitBox2c() : base("CircuitBox2c", LanguageHelper.GetFriendlyWord("CircuitBox2Name"), LanguageHelper.GetFriendlyWord("CircuitBox2Description"), AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox2c")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox2c"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: circuitBox2c.GetGameObject()");
#endif
