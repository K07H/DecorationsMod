...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public BarBottle4() : base("BarBottle4", LanguageHelper.GetFriendlyWord("BarBottleName"), LanguageHelper.GetFriendlyWord("BarBottleDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("barbottle04icon")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Update sky applier
                PrefabsHelper.UpdateOrAddSkyApplier(_barBottle4, null, new Renderer[] { renderer });
