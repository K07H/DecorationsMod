...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public AlienArtefact3() : base("AlienArtefact3", LanguageHelper.GetFriendlyWord("AlienRelic3Name"), LanguageHelper.GetFriendlyWord("AlienRelic3Description"), AssetsHelper.Assets.LoadAsset<Sprite>("relic_04_b")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("relic_04_b"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: alienArtefact3.GetGameObject()");
#endif
