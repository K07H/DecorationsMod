...
namespace DecorationsMod.NewItems
{
    public class GenericSkeleton2 : DecorationItem
    {
        ...
        public override void RegisterItem()
        {
            ...
            {
                GameObject model = this.GameObject.FindChild("Lost_river_generic_skeleton_02");
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("genericskeleton2icon")));
