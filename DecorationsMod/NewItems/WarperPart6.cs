    ...
    public class WarperPart6 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public WarperPart6() : base("WarperPart6", "WarperPartName", "WarperPartDescription", "warper_icon_6", "2")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.SetDefaultSkyApplier(_warperPart6, renderers);
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_6"));
#endif
