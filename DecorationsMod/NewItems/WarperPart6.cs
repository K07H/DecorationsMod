...
{
    public class WarperPart6 : DecorationItem
    {
        [SetsRequiredMembers]
        public WarperPart6() : base("WarperPart6", LanguageHelper.GetFriendlyWord("WarperPartName") + " (2)", LanguageHelper.GetFriendlyWord("WarperPartDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_6"))
        {
            this.ClassID = "WarperPart6";
            this.PrefabFileName = DecorationItem.DefaultResourcePath + this.ClassID;

            //this.GameObject = AssetsHelper.Assets.LoadAsset<GameObject>("warper_part_6");
        ...
        private static GameObject _warperPart6 = null;

        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                if (_warperPart6 == null)
                    _warperPart6 = AssetsHelper.Assets.LoadAsset<GameObject>("warper_part_6");

                GameObject model = _warperPart6.FindChild("Model");
                ...
                // Set tech tag
                var techTag = _warperPart6.AddComponent<TechTag>();
                techTag.type = this.TechType;

                // Add prefab identifier
                _warperPart6.AddComponent<PrefabIdentifier>().ClassId = this.ClassID;

                // Add collider
                var collider = _warperPart6.AddComponent<BoxCollider>();
                ...
                var renderers = _warperPart6.GetComponentsInChildren<Renderer>();
                ...
                PrefabsHelper.SetDefaultLargeWorldEntity(_warperPart6);

                // Add sky applier
                PrefabsHelper.UpdateOrAddSkyApplier(_warperPart6, null, renderers);

                // We can pick this item
                PrefabsHelper.SetDefaultPickupable(_warperPart6);

                // We can place this item
                _warperPart6.AddComponent<CustomPlaceToolController>();
                var placeTool = _warperPart6.AddComponent<GenericPlaceTool>();
                ...
                placeTool.ghostModelPrefab = _warperPart6;
                placeTool.mainCollider = collider;
                placeTool.pickupable = _warperPart6.GetComponent<Pickupable>();
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_6"));
        ...
        {
            GameObject prefab = GameObject.Instantiate(_warperPart6);
            ...
            fabricatingA.posOffset = new Vector3(0.01f, 0.04f, 0.04f);
