...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public WarperPart11() : base("WarperPart11", LanguageHelper.GetFriendlyWord("WarperPartName") + " (7)", LanguageHelper.GetFriendlyWord("WarperPartDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_11"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.UpdateOrAddSkyApplier(_warperPart11, null, renderers);
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_11"));
