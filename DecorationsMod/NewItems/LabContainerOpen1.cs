    ...
    public class LabContainerOpen1 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public LabContainerOpen1() : base("LabContainerOpen1", "LargeLabContainerOpenName", "LabContainerOpenDescription", "labcontaineropen1")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("labcontaineropen1"));
#endif
