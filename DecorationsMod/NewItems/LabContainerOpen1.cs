...
namespace DecorationsMod.NewItems
{
    public class LabContainerOpen1 : DecorationItem
    {
        public LabContainerOpen1() // Feeds abstract class
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Debris/Wrecks/Decoration/biodome_lab_containers_open_01";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, new Atlas.Sprite(ImageUtils.LoadTextureFromFile("./QMods/DecorationsMod/Assets/labcontaineropen1.png"))));
