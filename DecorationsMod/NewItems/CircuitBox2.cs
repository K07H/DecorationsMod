    ...
    public class CircuitBox2 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public CircuitBox2() : base("CircuitBox2", "CircuitBox2Name", "CircuitBox2Description", "circuitbox2")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox2"));
#endif
