...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public CircuitBox2() : base("CircuitBox2", LanguageHelper.GetFriendlyWord("CircuitBox2Name"), LanguageHelper.GetFriendlyWord("CircuitBox2Description"), AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox2")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox2"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: circuitBox2.GetGameObject()");
#endif
