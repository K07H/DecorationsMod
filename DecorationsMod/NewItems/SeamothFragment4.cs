...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public SeamothFragment4() : base("SeamothFragment4", LanguageHelper.GetFriendlyWord("SeamothFragmentName") + " (4)", LanguageHelper.GetFriendlyWord("SeamothFragmentDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment4icon")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment4icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: seamothFragment4.GetGameObject()");
#endif
