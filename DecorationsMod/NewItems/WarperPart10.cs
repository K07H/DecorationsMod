    ...
    public class WarperPart10 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public WarperPart10() : base("WarperPart10", "WarperPartName", "WarperPartDescription", "warper_icon_10", "6")
        {
        ...
        public WarperPart10()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("WarperPartName") + " (6)",
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.SetDefaultSkyApplier(_warperPart10, renderers);
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_10"));
#endif
