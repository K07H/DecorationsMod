...
namespace DecorationsMod.NewItems
{
    public class BarNapkins : DecorationItem
    {
        ...
        public override void RegisterItem()
        {
            ...
            {
                GameObject model = this.GameObject.FindChild("docking_food_01_napkin_group").FindChild("docking_food_01_napkin_group");
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("barnapkinsicon")));
