...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public SeamothFragment3() : base("SeamothFragment3", LanguageHelper.GetFriendlyWord("SeamothFragmentName") + " (3)", LanguageHelper.GetFriendlyWord("SeamothFragmentDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment3icon")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("seamothfragment3icon"));

                this.IsRegistered = true;
            }
        }

        private static GameObject _seamothFragment3 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: seamothFragment3.GetGameObject()");
#endif
            if (_seamothFragment3 == null)
#if SUBNAUTICA
                _seamothFragment3 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Fragments/seamoth_fragment_03.prefab");
#else
                _seamothFragment3 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Alterra/Fragments/seamoth_fragment_03.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_seamothFragment3);
