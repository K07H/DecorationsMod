...
namespace DecorationsMod.NewItems
{
    public class CargoBox01b : DecorationItem
    {
        ...
        [SetsRequiredMembers]
        public CargoBox01b() : base("CargoBox01b", LanguageHelper.GetFriendlyWord("CargoBox1bName"), LanguageHelper.GetFriendlyWord("CargoBox1bDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("cargobox01bicon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("cargobox01bicon"));
