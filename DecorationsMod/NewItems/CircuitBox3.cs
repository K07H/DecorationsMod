...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public CircuitBox3() : base("CircuitBox3", LanguageHelper.GetFriendlyWord("CircuitBox3Name"), LanguageHelper.GetFriendlyWord("CircuitBox3Description"), AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox3")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox3"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: circuitBox3.GetGameObject()");
#endif
