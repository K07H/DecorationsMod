...
namespace DecorationsMod.NewItems
{
    public class SofaStr2 : DecorationItem
    {
        ...
        [SetsRequiredMembers]
        public SofaStr2() : base("SofaStr2", LanguageHelper.GetFriendlyWord("SofaStr2Name"), LanguageHelper.GetFriendlyWord("SofaStr2Description"), AssetsHelper.Assets.LoadAsset<Sprite>("sofastr02icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                else
                {
                    ...
                    Nautilus.Handlers.CraftDataHandler.SetItemSize(this.TechType, new Vector2int(3, 2));
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("sofastr02icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: sofaStr2.GetGameObject()");
#endif
            if (_sofaStr2 == null)
