        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                else
                {
                    ...
                    CraftDataPatcher.customItemSizes[this.TechType] = new Vector2int(3, 2);
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("sofastr02icon")));
