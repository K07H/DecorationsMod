...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public Marki2() : base("MarkiDoll2", LanguageHelper.GetFriendlyWord("MarkiDollName"), LanguageHelper.GetFriendlyWord("MarkiDollDescription"), SpriteManager.Get(TechType.Marki2))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Set the custom icon
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, SpriteManager.Get(TechType.Marki2));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: marki2.GetGameObject()");
#endif
            if (_marki2 == null)
