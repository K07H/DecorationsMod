...
namespace DecorationsMod.NewItems
{
    public class BarBottle1 : DecorationItem
    {
        ...
        public override void RegisterItem()
        {
            ...
            {
                GameObject model = this.GameObject.FindChild("docking_bar_bottle_01").FindChild("docking_bar_bottle_01");
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("barbottle01icon")));
