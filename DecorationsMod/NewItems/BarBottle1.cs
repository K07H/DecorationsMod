...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public BarBottle1() : base("BarBottle1", LanguageHelper.GetFriendlyWord("BarBottleName"), LanguageHelper.GetFriendlyWord("BarBottleDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("barbottle01icon")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Update sky applier
                PrefabsHelper.UpdateOrAddSkyApplier(_barBottle1, null, new Renderer[] { renderer });
