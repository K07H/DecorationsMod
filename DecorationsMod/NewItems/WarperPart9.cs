...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public WarperPart9() : base("WarperPart9", LanguageHelper.GetFriendlyWord("WarperPartName") + " (5)", LanguageHelper.GetFriendlyWord("WarperPartDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_9"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.UpdateOrAddSkyApplier(_warperPart9, null, renderers);
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_9"));
