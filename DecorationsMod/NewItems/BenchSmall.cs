...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public BenchSmall() : base("BenchSmall", LanguageHelper.GetFriendlyWord("BenchSmallName"), LanguageHelper.GetFriendlyWord("BenchDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("benchsmallicon"))
        {
            ...
            CrafterLogicFixer.BenchSmall = this.TechType;
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("benchsmallicon"));
