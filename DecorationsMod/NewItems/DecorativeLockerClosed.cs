    ...
    public class DecorativeLockerClosed : DecorationItem
    {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Set the custom icon
                SpriteHandler.RegisterSprite(this.TechType, new Atlas.Sprite(ImageUtils.LoadTextureFromFile("./QMods/DecorationsMod/Assets/decorativelockerclosedicon.png"))); //AssetsHelper.Assets.LoadAsset<Sprite>("decorativelockericon"));
