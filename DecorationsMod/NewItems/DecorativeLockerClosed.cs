...
namespace DecorationsMod.NewItems
{
    public class DecorativeLockerClosed : DecorationItem
    {
        ...
        [SetsRequiredMembers]
        public DecorativeLockerClosed() : base("DecorativeLockerClosed", LanguageHelper.GetFriendlyWord("DecorativeLockerName"), LanguageHelper.GetFriendlyWord("DecorativeLockerDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("decorativelockerclosedicon")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Set the custom icon
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("decorativelockerclosedicon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: lockerClosed.GetGameObject()");
#endif
