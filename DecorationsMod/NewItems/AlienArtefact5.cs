...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public AlienArtefact5() : base("AlienArtefact5", LanguageHelper.GetFriendlyWord("AlienRelic5Name"), LanguageHelper.GetFriendlyWord("AlienRelic5Description"), AssetsHelper.Assets.LoadAsset<Sprite>("relic_06_b")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("relic_06_b"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: alienArtefact5.GetGameObject()");
#endif
