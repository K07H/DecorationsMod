    ...
    public class WarperPart3 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public WarperPart3() : base("WarperPart3", "HangingWarperPartName", "HangingWarperPartDescription", "warper_icon_3", "2")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.SetDefaultSkyApplier(_warperPart3, renderers);
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_3"));
#endif
