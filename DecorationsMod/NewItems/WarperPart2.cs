...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public WarperPart2() : base("WarperPart2", LanguageHelper.GetFriendlyWord("HangingWarperPartName") + " (1)", LanguageHelper.GetFriendlyWord("HangingWarperPartDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_2"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.UpdateOrAddSkyApplier(_warperPart2, null, renderers); // dynamic true?
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_2"));
