    ...
    public class EggCrabsnake : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public EggCrabsnake() : base(new PrefabInfo("8a211aaf-d471-48f0-b73f-eddc22b8c025",
#if SUBNAUTICA
            "WorldEntities/Eggs/CrabsnakeEgg.prefab",
#else
            "WorldEntities/Eggs/Legacy/CrabsnakeEgg.prefab", 
#endif
...
#if SUBNAUTICA
            this.PrefabFileName = "WorldEntities/Eggs/CrabsnakeEgg.prefab";
#else
            this.PrefabFileName = "WorldEntities/Eggs/Legacy/CrabsnakeEgg.prefab";
#endif
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CraftDataHandler.SetQuickSlotType(TechType.CrabsnakeEggUndiscovered, QuickSlotType.Selectable);

                this.IsRegistered = true;
            }
        }

        private static GameObject _eggCrabsnake = null;

        public override GameObject GetGameObject()
        {
            if (_eggCrabsnake == null)
                _eggCrabsnake = PrefabsHelper.LoadGameObjectFromFilename(this.PrefabFileName);

            GameObject prefab = GameObject.Instantiate(_eggCrabsnake);
