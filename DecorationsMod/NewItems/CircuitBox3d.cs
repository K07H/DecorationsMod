...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public CircuitBox3d() : base("CircuitBox3d", LanguageHelper.GetFriendlyWord("CircuitBox3Name"), LanguageHelper.GetFriendlyWord("CircuitBox3Description"), AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox3d")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("circuitbox3d"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: circuitBox3d.GetGameObject()");
#endif
