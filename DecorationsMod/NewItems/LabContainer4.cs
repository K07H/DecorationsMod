...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public LabContainer4() : base("LabContainer4", LanguageHelper.GetFriendlyWord("LabContainer4Name"), LanguageHelper.GetFriendlyWord("LabContainer4Description"), AssetsHelper.Assets.LoadAsset<Sprite>("labcontainer4")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("labcontainer4"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: labContainer4.GetGameObject()");
#endif
