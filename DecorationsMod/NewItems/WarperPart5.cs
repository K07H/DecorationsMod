    ...
    public class WarperPart5 : DecorationItem
    {
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public WarperPart5() : base("WarperPart5", "WarperPartName", "WarperPartDescription", "warper_icon_5", "1")
        {
        ...
        public WarperPart5()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("WarperPartName") + " (1)",
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add sky applier
                PrefabsHelper.SetDefaultSkyApplier(_warperPart5, renderers);
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("warper_icon_5"));
#endif
