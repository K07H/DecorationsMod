...
namespace DecorationsMod.NewItems
{
    ...
    {
        [SetsRequiredMembers]
        public AlienArtefact8() : base("AlienArtefact8", LanguageHelper.GetFriendlyWord("AlienRelic8Name"), LanguageHelper.GetFriendlyWord("AlienRelic8Description"), AssetsHelper.Assets.LoadAsset<Sprite>("relic_08_b")) // Feeds abstract class
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("relic_08_b"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: alienArtefact8.GetGameObject()");
#endif
