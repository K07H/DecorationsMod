        ...
        public void OnHandClick(GUIHand hand)
        {
            ...
            if (Input.GetKey(KeyCode.E))
            {
                ...
                if (model.transform.localScale.y > 2.0f)
                {
                    ...
                    Logger.Debug("DEBUG: Resetting WarperSpecimen size to [0.5;0.5;0.5] and collider to [0.004;0.004;0.019]");
#endif
                ...
                {
#if DEBUG_WARPER_SPECIMEN
                    Logger.Debug("DEBUG: Increasing WarperSpecimen size from [{0};{1};{2}].", model.transform.localScale.x.ToString("0.000", CultureInfo.InvariantCulture), model.transform.localScale.y.ToString("0.000", CultureInfo.InvariantCulture), model.transform.localScale.z.ToString("0.000", CultureInfo.InvariantCulture));
#endif
                    model.transform.localScale *= ScaleRatio;
#if DEBUG_WARPER_SPECIMEN
                    Logger.Debug("DEBUG: Increasing WarperSpecimen size to [{0};{1};{2}].", model.transform.localScale.x.ToString("0.000", CultureInfo.InvariantCulture), model.transform.localScale.y.ToString("0.000", CultureInfo.InvariantCulture), model.transform.localScale.z.ToString("0.000", CultureInfo.InvariantCulture));
                    Logger.Debug("DEBUG: Increasing WarperSpecimen collider from [{0};{1};{2}].", collider.size.x.ToString("0.000", CultureInfo.InvariantCulture), collider.size.y.ToString("0.000", CultureInfo.InvariantCulture), collider.size.z.ToString("0.000", CultureInfo.InvariantCulture));
#endif
                    collider.size *= ScaleRatio;
#if DEBUG_WARPER_SPECIMEN
                    Logger.Debug("DEBUG: Increasing WarperSpecimen size from [{0};{1};{2}].", collider.size.x.ToString("0.000", CultureInfo.InvariantCulture), collider.size.y.ToString("0.000", CultureInfo.InvariantCulture), collider.size.z.ToString("0.000", CultureInfo.InvariantCulture));
#endif
                }
            }
        }
