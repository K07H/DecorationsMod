...
namespace DecorationsMod.Flora
{
    public class TropicalPlant7a : DecorationItem, ICustomFlora
    {
        ...
        public TropicalPlant7a()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Tropical Plant 7a";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant7aicon")));
