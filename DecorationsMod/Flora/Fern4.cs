...
namespace DecorationsMod.Flora
{
    public class Fern4 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public Fern4() : base("Fern4", LanguageHelper.GetFriendlyWord("Fern2Name"), LanguageHelper.GetFriendlyWord("FernDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("fern4icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("fern4icon"));
        ...
        private static GameObject _fern4 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: fern4.GetGameObject()");
#endif
            if (_fern4 == null)
#if SUBNAUTICA
                _fern4 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Fern 04.prefab");
#else
                _fern4 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/fern 04.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_fern4);
