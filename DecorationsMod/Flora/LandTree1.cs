...
namespace DecorationsMod.Flora
{
    public class LandTree1 : DecorationItem, ICustomFlora
    {
        ...
        public LandTree1()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Land_tree_01";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landtree1seedicon")));
