...
{
    public class LandPlant5 : DecorationItem, ICustomFlora
    {
        ...
        public LandPlant5()
        {
            this.ClassID = "LandPlant5"; // e2be8784-75d6-4b86-941e-9aac73e0b72b
            this.PrefabFileName = DecorationItem.DefaultResourcePath + this.ClassID;

            this.GameObject = new GameObject(this.ClassID);

            this.TechType = SMLHelper.V2.Handlers.TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("LandPlant5Name"),
                                                        LanguageHelper.GetFriendlyWord("LandPlant5Description"),
                                                        true);
            ...
            this.Config = ConfigSwitcher.config_LandPlant5;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SMLHelper.V2.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant5icon"));
        ...
        private static GameObject _landPlant5 = null;

        public override GameObject GetGameObject()
        {
            if (_landPlant5 == null)
#if SUBNAUTICA
                _landPlant5 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/land_plant_middle_09.prefab");
#else
                _landPlant5 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/land_plant_middle_09.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_landPlant5);
            ...
            plantable.linkedGrownPlant.seedUID = "LandPlant5";
