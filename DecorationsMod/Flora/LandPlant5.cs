...
namespace DecorationsMod.Flora
{
    public class LandPlant5 : DecorationItem, ICustomFlora
    {
        ...
        public LandPlant5()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/land_plant_middle_09";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant5icon")));
