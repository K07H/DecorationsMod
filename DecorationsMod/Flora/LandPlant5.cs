...
namespace DecorationsMod.Flora
{
    public class LandPlant5 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public LandPlant5() : base("LandPlant5", LanguageHelper.GetFriendlyWord("LandPlant5Name"), LanguageHelper.GetFriendlyWord("LandPlant5Description"), AssetsHelper.Assets.LoadAsset<Sprite>("landplant5icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant5icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: landPlant5.GetGameObject()");
#endif
            if (_landPlant5 == null)
#if SUBNAUTICA
