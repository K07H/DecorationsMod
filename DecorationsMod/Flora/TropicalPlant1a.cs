...
namespace DecorationsMod.Flora
{
    public class TropicalPlant1a : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public TropicalPlant1a() : base("TropicalPlant1a", LanguageHelper.GetFriendlyWord("TropicalPlantName"), LanguageHelper.GetFriendlyWord("TropicalPlantDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant1aicon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant1aicon"));
        ...
        private static GameObject _tropicalPlant1a = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: tropicalPlant1a.GetGameObject()");
#endif
            if (_tropicalPlant1a == null)
#if SUBNAUTICA
                _tropicalPlant1a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Tropical Plant 1a.prefab");
#else
                _tropicalPlant1a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/Tropical Plant 1a.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_tropicalPlant1a);
