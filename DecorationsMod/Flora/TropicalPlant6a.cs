    ...
    public class TropicalPlant6a : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public TropicalPlant6a() : base("TropicalPlant6a", "TropicalTree3Name", "TropicalTreeDescription", "tropicalplant6aicon")
        {
            this.GameObject = new GameObject(this.ClassID);
#else
        public TropicalPlant6a()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("TropicalTree3Name"),
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant6aicon"));
#endif
