...
namespace DecorationsMod.Flora
{
    public class TropicalPlant6a : DecorationItem, ICustomFlora
    {
        ...
        public TropicalPlant6a()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Tropical Plant 6a";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant6aicon")));
