...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/flora/old/Tropical Plant 6a");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Land/Tropical Plant 6a");
#endif

            this.TechType = SMLHelper.V2.Handlers.TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("TropicalTreeName") + " (3)",
