...
{
    public class TropicalPlant6a : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public TropicalPlant6a() : base("TropicalPlant6a", LanguageHelper.GetFriendlyWord("TropicalTree3Name"), LanguageHelper.GetFriendlyWord("TropicalTreeDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant6aicon"))
        {
            this.ClassID = "TropicalPlant6a"; // 05400893-7eda-48d0-bd25-3977932f509c
            ...
            this.Config = ConfigSwitcher.config_TropicalTreeC;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant6aicon"));
        ...
        private static GameObject _tropicalPlant6a = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: tropicalPlant6a.GetGameObject()");
#endif
            if (_tropicalPlant6a == null)
#if SUBNAUTICA
                _tropicalPlant6a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Tropical Plant 6a.prefab");
#else
                _tropicalPlant6a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/Tropical Plant 6a.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_tropicalPlant6a);
            ...
            // Scale prefab
            prefab.FindChild("Tropical_plant_6a").transform.localScale *= 0.22f;
            ...
            plantable.linkedGrownPlant.seedUID = "TropicalPlant6a";
