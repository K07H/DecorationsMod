...
{
    public class TropicalPlant7b : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public TropicalPlant7b() : base("TropicalPlant7b", LanguageHelper.GetFriendlyWord("TropicalPlant6Name"), LanguageHelper.GetFriendlyWord("TropicalPlantDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant7bicon"))
        {
            this.ClassID = "TropicalPlant7b"; // 8798f4c7-f13d-4a8e-9947-b4f7fc1f1bae
            ...
            this.Config = ConfigSwitcher.config_TropicalPlantF;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant7bicon"));
        ...
        private static GameObject _tropicalPlant7b = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: tropicalPlant7b.GetGameObject()");
#endif
            if (_tropicalPlant7b == null)
#if SUBNAUTICA
                _tropicalPlant7b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Tropical Plant 7b.prefab");
#else
                _tropicalPlant7b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/Tropical Plant 7b.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_tropicalPlant7b);
            ...
            // Scale prefab
            prefab.FindChild("Tropical_Plant_7b").transform.localScale *= 0.25f;
            ...
            plantable.linkedGrownPlant.seedUID = "TropicalPlant7b";
