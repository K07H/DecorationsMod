...
namespace DecorationsMod.Flora
{
    public class LandPlant3 : DecorationItem, ICustomFlora
    {
        ...
        public LandPlant3()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/land_plant_middle_07";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant3icon")));
