...
{
    public class LandPlant3 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public LandPlant3() : base("LandPlant3", LanguageHelper.GetFriendlyWord("LandPlant3Name"), LanguageHelper.GetFriendlyWord("LandPlant3Description"), AssetsHelper.Assets.LoadAsset<Sprite>("landplant3icon"))
        {
            ...
            this.Config = ConfigSwitcher.config_LandPlant3;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                // Add the new TechType to bioreactor equipment
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant3icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: landPlant3.GetGameObject()");
#endif
            if (_landPlant3 == null)
#if SUBNAUTICA
            ...
            plantable.linkedGrownPlant.seedUID = "LandPlant3";
