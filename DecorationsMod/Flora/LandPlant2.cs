    ...
    public class LandPlant2 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public LandPlant2() : base("LandPlant2", "LandPlant2Name", "LandPlant2Description", "landplant2icon")
        {
        ...
        public LandPlant2()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("LandPlant2Name"),
                                                        LanguageHelper.GetFriendlyWord("LandPlant2Description"),
                                                        true);
#endif
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant2icon"));
#endif
