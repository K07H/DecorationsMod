...
namespace DecorationsMod.Flora
{
    public class LandPlant2 : DecorationItem, ICustomFlora
    {
        ...
        public LandPlant2()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/land_plant_middle_06_02";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant2icon")));
