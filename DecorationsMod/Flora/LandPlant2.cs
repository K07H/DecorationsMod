...
{
    public class LandPlant2 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public LandPlant2() : base("LandPlant2", LanguageHelper.GetFriendlyWord("LandPlant2Name"), LanguageHelper.GetFriendlyWord("LandPlant2Description"), AssetsHelper.Assets.LoadAsset<Sprite>("landplant2icon"))
        {
            this.ClassID = "LandPlant2";
            ...
            this.Config = ConfigSwitcher.config_LandPlant2;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant2icon"));
        ...
        private static GameObject _landPlant2 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: landPlant2.GetGameObject()");
#endif
            if (_landPlant2 == null)
#if SUBNAUTICA
                _landPlant2 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/land_plant_middle_06_02.prefab");
#else
                _landPlant2 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/land_plant_middle_06_02.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_landPlant2);
            ...
            plantable.linkedGrownPlant.seedUID = "LandPlant2";
