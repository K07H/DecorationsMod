...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/flora/old/Tropical Plant 10a");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Land/Tropical Plant 10a");
#endif

            this.TechType = SMLHelper.V2.Handlers.TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("TropicalPlantName") + " (7)",
