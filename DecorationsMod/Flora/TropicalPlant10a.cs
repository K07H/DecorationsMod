...
namespace DecorationsMod.Flora
{
    public class TropicalPlant10a : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public TropicalPlant10a() : base("TropicalPlant10a", LanguageHelper.GetFriendlyWord("TropicalPlant7Name"), LanguageHelper.GetFriendlyWord("TropicalPlantDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant10aicon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant10aicon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: tropicalPlant10a.GetGameObject()");
#endif
