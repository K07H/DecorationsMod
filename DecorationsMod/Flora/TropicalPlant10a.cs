...
{
    public class TropicalPlant10a : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public TropicalPlant10a() : base("TropicalPlant10a", "TropicalPlant7Name", "TropicalPlantDescription", "tropicalplant10aicon")
        {
            this.GameObject = new GameObject(this.ClassID);
#else
        public TropicalPlant10a()
        {
            this.ClassID = "TropicalPlant10a"; // 75ab087f-9934-4e2a-b025-02fc333a5c99
            this.PrefabFileName = DecorationItem.DefaultResourcePath + this.ClassID;

            this.GameObject = new GameObject(this.ClassID);

            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("TropicalPlant7Name"),
            ...
            this.Config = ConfigSwitcher.config_TropicalPlantG;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant10aicon"));
#endif
        ...
        private static GameObject _tropicalPlant10a = null;

        public override GameObject GetGameObject()
        {
            if (_tropicalPlant10a == null)
#if SUBNAUTICA
                _tropicalPlant10a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Tropical Plant 10a.prefab");
#else
                _tropicalPlant10a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/Tropical Plant 10a.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_tropicalPlant10a);
            ...
            // Scale prefab
            prefab.FindChild("Tropical_Plant_10a").transform.localScale *= 0.2f;
            ...
            plantable.linkedGrownPlant.seedUID = "TropicalPlant10a";
