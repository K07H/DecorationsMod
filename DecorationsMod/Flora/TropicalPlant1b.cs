...
namespace DecorationsMod.Flora
{
    public class TropicalPlant1b : DecorationItem, ICustomFlora
    {
        ...
        public TropicalPlant1b()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Tropical Plant 1b";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant1bicon")));
