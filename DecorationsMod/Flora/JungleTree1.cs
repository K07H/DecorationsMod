...
namespace DecorationsMod.Flora
{
    public class JungleTree1 : DecorationItem, ICustomFlora
    {
        ...
        public JungleTree1()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Jungle Tree 3a";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("jungletree1icon")));
