...
namespace DecorationsMod.Flora
{
    public class JungleTree2 : DecorationItem, ICustomFlora
    {
        ...
        public JungleTree2()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Jungle Tree 3b";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("jungletree2icon")));
