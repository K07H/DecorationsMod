...
{
    public class TropicalPlant2a : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public TropicalPlant2a() : base("TropicalPlant2a", LanguageHelper.GetFriendlyWord("TropicalPlant3Name"), LanguageHelper.GetFriendlyWord("TropicalPlantDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant2aicon"))
        {
            this.ClassID = "TropicalPlant2a"; // 8861b7cf-3c7b-481e-b4ff-83b49206acb8
            ...
            this.Config = ConfigSwitcher.config_TropicalPlantC;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant2aicon"));
        ...
        private static GameObject _tropicalPlant2a = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: tropicalPlant2a.GetGameObject()");
#endif
            if (_tropicalPlant2a == null)
#if SUBNAUTICA
                _tropicalPlant2a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Tropical Plant 2a.prefab");
#else
                _tropicalPlant2a = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/Tropical Plant 2a.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_tropicalPlant2a);
            ...
            // Scale prefab
            prefab.FindChild("Tropical_plant_2a").transform.localScale *= 0.15f;
            ...
            plantable.linkedGrownPlant.seedUID = "TropicalPlant2a";
