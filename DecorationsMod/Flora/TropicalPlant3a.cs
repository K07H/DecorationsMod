...
namespace DecorationsMod.Flora
{
    public class TropicalPlant3a : DecorationItem, ICustomFlora
    {
        ...
        public TropicalPlant3a()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Tropical Plant 3a";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant3aicon")));
