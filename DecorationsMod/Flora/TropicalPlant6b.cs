...
{
    public class TropicalPlant6b : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public TropicalPlant6b() : base("TropicalPlant6b", LanguageHelper.GetFriendlyWord("TropicalTree4Name"), LanguageHelper.GetFriendlyWord("TropicalTreeDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant6bicon"))
        {
            this.ClassID = "TropicalPlant6b"; // 154a88c1-6c7f-44e4-974e-c52d2f48fa28
            ...
            this.Config = ConfigSwitcher.config_TropicalTreeD;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant6bicon"));
        ...
        private static GameObject _tropicalPlant6b = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: tropicalPlant6b.GetGameObject()");
#endif
            if (_tropicalPlant6b == null)
#if SUBNAUTICA
                _tropicalPlant6b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Tropical Plant 6b.prefab");
#else
                _tropicalPlant6b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/Tropical Plant 6b.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_tropicalPlant6b);
            ...
            // Scale prefab
            prefab.FindChild("Tropical_plant_6b").transform.localScale *= 0.22f;
            ...
            plantable.linkedGrownPlant.seedUID = "TropicalPlant6b";
