...
namespace DecorationsMod.Flora
{
    public class TropicalPlant6b : DecorationItem, ICustomFlora
    {
        ...
        public TropicalPlant6b()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Tropical Plant 6b";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant6bicon")));
