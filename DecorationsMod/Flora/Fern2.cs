...
{
    public class Fern2 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public Fern2() : base("Fern2", LanguageHelper.GetFriendlyWord("FernName"), LanguageHelper.GetFriendlyWord("FernDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("fern2icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("fern2icon"));
        ...
        private static GameObject _fern2 = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: fern2.GetGameObject()");
#endif
            if (_fern2 == null)
#if SUBNAUTICA
                _fern2 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Fern 02.prefab");
#else
                _fern2 = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/fern 02.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_fern2);
