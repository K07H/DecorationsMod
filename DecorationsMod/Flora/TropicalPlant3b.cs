...
{
    public class TropicalPlant3b : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public TropicalPlant3b() : base("TropicalPlant3b", LanguageHelper.GetFriendlyWord("TropicalTree2Name"), LanguageHelper.GetFriendlyWord("TropicalTreeDescription"), AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant3bicon"))
        {
            this.ClassID = "TropicalPlant3b"; // 7d36a1fd-8aa1-4b32-9e05-23176e119f5f
            ...
            this.Config = ConfigSwitcher.config_TropicalTreeB;
        }
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant3bicon"));
        ...
        private static GameObject _tropicalPlant3b = null;

        public override GameObject GetGameObject()
        {
#if DEBUG_ITEMS_REGISTRATION
            Logger.Info("INFO: tropicalPlant3b.GetGameObject()");
#endif
            if (_tropicalPlant3b == null)
#if SUBNAUTICA
                _tropicalPlant3b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/Doodads/Land/Tropical Plant 3b.prefab");
#else
                _tropicalPlant3b = PrefabsHelper.LoadGameObjectFromFilename("WorldEntities/flora/old/Tropical Plant 3b.prefab");
#endif

            GameObject prefab = GameObject.Instantiate(_tropicalPlant3b);
            ...
            // Scale prefab
            prefab.FindChild("Tropical_Plant_3b").transform.localScale *= 0.22f;
            ...
            plantable.linkedGrownPlant.seedUID = "TropicalPlant3b";
