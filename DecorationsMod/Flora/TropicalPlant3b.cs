...
namespace DecorationsMod.Flora
{
    public class TropicalPlant3b : DecorationItem, ICustomFlora
    {
        ...
        public TropicalPlant3b()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Tropical Plant 3b";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant3bicon")));
