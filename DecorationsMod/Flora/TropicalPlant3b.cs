...
#if BELOWZERO
            this.GameObject = Resources.Load<GameObject>("WorldEntities/flora/old/Tropical Plant 3b");
#else
            this.GameObject = Resources.Load<GameObject>("WorldEntities/Doodads/Land/Tropical Plant 3b");
#endif

            this.TechType = SMLHelper.V2.Handlers.TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("TropicalTreeName") + " (B)",
