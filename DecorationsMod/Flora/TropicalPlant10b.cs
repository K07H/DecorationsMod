...
namespace DecorationsMod.Flora
{
    public class TropicalPlant10b : DecorationItem, ICustomFlora
    {
        ...
        public TropicalPlant10b()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/Tropical Plant 10b";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant10bicon")));
