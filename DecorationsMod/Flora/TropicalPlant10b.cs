    ...
    public class TropicalPlant10b : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public TropicalPlant10b() : base("TropicalPlant10b", "TropicalPlant8Name", "TropicalPlantDescription", "tropicalplant10bicon")
        {
            this.GameObject = new GameObject(this.ClassID);
#else
        public TropicalPlant10b()
        {
            ...
            this.TechType = TechTypeHandler.AddTechType(this.ClassID,
                                                        LanguageHelper.GetFriendlyWord("TropicalPlant8Name"),
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("tropicalplant10bicon"));
#endif
