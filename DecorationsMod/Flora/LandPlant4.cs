...
namespace DecorationsMod.Flora
{
    public class LandPlant4 : DecorationItem, ICustomFlora
    {
        ...
        public LandPlant4()
        {
            ...
            this.ResourcePath = "WorldEntities/Doodads/Land/land_plant_middle_08";
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                CustomSpriteHandler.customSprites.Add(new CustomSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant4icon")));
