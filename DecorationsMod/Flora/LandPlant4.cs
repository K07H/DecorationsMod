    ...
    public class LandPlant4 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public LandPlant4() : base("LandPlant4", "LandPlant4Name", "LandPlant4Description", "landplant4icon")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant4icon"));
#endif
