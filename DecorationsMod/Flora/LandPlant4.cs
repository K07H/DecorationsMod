...
namespace DecorationsMod.Flora
{
    public class LandPlant4 : DecorationItem, ICustomFlora
    {
        ...
        [SetsRequiredMembers]
        public LandPlant4() : base("LandPlant4", LanguageHelper.GetFriendlyWord("LandPlant4Name"), LanguageHelper.GetFriendlyWord("LandPlant4Description"), AssetsHelper.Assets.LoadAsset<Sprite>("landplant4icon"))
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                Nautilus.Handlers.SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant4icon"));
        ...
        public override GameObject GetGameObject()
        {
            ...
            Logger.Info("INFO: landPlant4.GetGameObject()");
#endif
            if (_landPlant4 == null)
#if SUBNAUTICA
