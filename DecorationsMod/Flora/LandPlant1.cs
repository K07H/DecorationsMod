    ...
    public class LandPlant1 : DecorationItem, ICustomFlora
    {
...
#if SUBNAUTICA_NAUTILUS
        [SetsRequiredMembers]
        public LandPlant1() : base("LandPlant1", "LandPlant1Name", "LandPlant1Description", "landplant1icon")
        {
        ...
        public override void RegisterItem()
        {
            if (this.IsRegistered == false)
            {
                ...
                SpriteHandler.RegisterSprite(this.TechType, AssetsHelper.Assets.LoadAsset<Sprite>("landplant1icon"));
#endif
