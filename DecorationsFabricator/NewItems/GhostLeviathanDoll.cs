    ...
    public class GhostLeviathanDoll : DecorationItem
    {
        ...
        public override GameObject GetPrefab()
        {
            if (this.GameObject == null)
                Logger.Log("No ghost leviathan game Object!!!");
            ...
            GameObject.DestroyImmediate(liveMixin);
            ...
            var locomotion = prefab.GetComponent<Locomotion>();
            GameObject.DestroyImmediate(locomotion);
            ...
            var lastScarePosition = prefab.GetComponent<LastScarePosition>();
            GameObject.DestroyImmediate(lastScarePosition);

            var lastTarget = prefab.GetComponent<LastTarget>();
            GameObject.DestroyImmediate(lastTarget);
